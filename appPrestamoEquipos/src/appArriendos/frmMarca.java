    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            else
            {
                  ...
                  statement.execute("insert into tb_marca (descripcion) values('"+descripcion+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                int cantidad = statement.executeUpdate("UPDATE tb_marca SET descripcion = '"+ descripcion +"' WHERE codigo = '"+ codigo +"'");
                if(cantidad > 0)
                {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                Statement statement=(Statement) miConexion.createStatement();
                String codigo = txtcodigo.getText();
                int cantidad = statement.executeUpdate("DELETE FROM tb_marca where codigo = '"+ codigo +"'");
                if(cantidad > 0)
                {
    ...
    private void txtcodigoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcodigoKeyTyped
      ...
      private void ObtenerRegistro(String codigo){
        ...
        try
        {
             ...
             Connection miConexion=(Connection) Conexion.GetConnection();
             Statement statement=(Statement) miConexion.createStatement();
             rs = statement.executeQuery("SELECT * from tb_marca where codigo = '"+ codigo +"'");
